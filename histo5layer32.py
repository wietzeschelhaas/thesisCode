# -*- coding: utf-8 -*-
"""
Created on Tue May 12 10:38:25 2020
...
# -*- coding: utf-8 -*-
"""
Created on Tue May 12 10:34:20 2020
...
for i in range(20):
    ...
    model = Sequential()
    model.add(LSTM(32,input_shape=(FUTURE_PERIOD_PREDICT,47),activation="tanh",return_sequences=True))
    model.add(Dropout(0.2))
    model.add(BatchNormalization())
    
    model.add(LSTM(32,input_shape=(x_train.shape[1:]),activation="tanh",return_sequences=True))
    model.add(Dropout(0.1))
    model.add(BatchNormalization())
    
    model.add(LSTM(32,activation="relu",input_shape=(FUTURE_PERIOD_PREDICT ,47)))
    model.add(Dropout(0.2))
    model.add(BatchNormalization())
    ...
    checkpoint_path = r"C:\Users\wietz\Desktop\5layer32\4layern="+ str(FUTURE_PERIOD_PREDICT) + " (1).h5"
