# -*- coding: utf-8 -*-
"""
Created on Tue May 12 10:24:08 2020
...
for i in range(20):
    ...
    model.add(LSTM(16,activation="relu",input_shape=(x_train.shape[1:])))
    model.add(Dropout(0.2))
    model.add(BatchNormalization())
    ...
    checkpoint_path = r"C:\Users\wietz\Desktop\4layer16\4layern="+ str(FUTURE_PERIOD_PREDICT) + " (3).h5"
